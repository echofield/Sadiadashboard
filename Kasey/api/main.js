    ...
    <div class="space-y-6">
      ...
      <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
        ...
        <div class="flex items-center gap-4">
          <button id="refresh-button" class="p-2 rounded-xl hover:bg-white/30 transition-colors border border-white/30" style="${glassStyle}">
          ...
          <div class="rounded-xl px-6 py-3 shadow-lg border border-white/30" style="${glassStyle}">
...
const renderStats = (stats) => {
  ...
  statsGrid.innerHTML = `
    <div class="rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105" style="${glassStyle}">
...
const renderNudgeBanner = async (recentActivity) => {
  ...
  if (completedActivity) {
    nudgeBannerEl.innerHTML = `
      <div class="rounded-2xl p-6 shadow-xl bg-blue-50/50 border-blue-200" style="${glassStyle}">
...
const renderCharts = (data) => {
  ...
  chartsSection.innerHTML = `
    <div class="rounded-2xl p-6 shadow-xl" style="${glassStyle}">
  ...
  // Placeholder SVG's to give the visual feel of the original charts.
